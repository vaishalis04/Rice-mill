...
module.exports = {
  getAll: async (req, res, next) => {
    try {
      // TODO: list accounts with filters / pagination
  ...
  getById: async (req, res, next) => {
    try {
      // TODO: fetch single accounts by req.params.id
  ...
  create: async (req, res, next) => {
    try {
      // TODO: create accounts from req.body
  ...
  update: async (req, res, next) => {
    try {
      // TODO: update accounts req.params.id with req.body
  ...
  delete: async (req, res, next) => {
    try {
      // TODO: soft-delete accounts req.params.id (is_deleted = true)
