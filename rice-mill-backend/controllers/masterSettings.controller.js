...
module.exports = {
  getAll: async (req, res, next) => {
    try {
      // TODO: list masterSettings with filters / pagination
  ...
  getById: async (req, res, next) => {
    try {
      // TODO: fetch single masterSettings by req.params.id
  ...
  create: async (req, res, next) => {
    try {
      // TODO: create masterSettings from req.body
  ...
  update: async (req, res, next) => {
    try {
      // TODO: update masterSettings req.params.id with req.body
  ...
  delete: async (req, res, next) => {
    try {
      // TODO: soft-delete masterSettings req.params.id (is_deleted = true)
