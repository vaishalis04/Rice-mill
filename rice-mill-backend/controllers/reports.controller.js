...
module.exports = {
  getAll: async (req, res, next) => {
    try {
      // TODO: list reports with filters / pagination
  ...
  getById: async (req, res, next) => {
    try {
      // TODO: fetch single reports by req.params.id
  ...
  create: async (req, res, next) => {
    try {
      // TODO: create reports from req.body
  ...
  update: async (req, res, next) => {
    try {
      // TODO: update reports req.params.id with req.body
  ...
  delete: async (req, res, next) => {
    try {
      // TODO: soft-delete reports req.params.id (is_deleted = true)
