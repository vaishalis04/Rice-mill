...
module.exports = {
  getAll: async (req, res, next) => {
    try {
      // TODO: list vendor with filters / pagination
  ...
  getById: async (req, res, next) => {
    try {
      // TODO: fetch single vendor by req.params.id
  ...
  create: async (req, res, next) => {
    try {
      // TODO: create vendor from req.body
  ...
  update: async (req, res, next) => {
    try {
      // TODO: update vendor req.params.id with req.body
  ...
  delete: async (req, res, next) => {
    try {
      // TODO: soft-delete vendor req.params.id (is_deleted = true)
