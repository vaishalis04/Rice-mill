...
MaterialMaster.belongsTo(VarietyMaster, { foreignKey: "variety_id", as: "variety" });
BinStackMaster.belongsTo(WarehouseMaster, { foreignKey: "warehouse_id", as: "warehouse" });
RateMaster.belongsTo(MaterialMaster, { foreignKey: "material_id", as: "material" });
RateMaster.belongsTo(VarietyMaster, { foreignKey: "variety_id", as: "variety" });
PurchaseOrder.belongsTo(Vendor, { foreignKey: "vendor_id", as: "vendor" });
PurchaseOrder.belongsTo(MaterialMaster, { foreignKey: "material_id", as: "material" });
PurchaseOrder.belongsTo(VarietyMaster, { foreignKey: "variety_id", as: "variety" });
...
Inventory.belongsTo(MaterialMaster, { foreignKey: "material_id", as: "material" });
Inventory.belongsTo(WarehouseMaster, { foreignKey: "warehouse_id", as: "warehouse" });
QualityCheck.belongsTo(ProductionBatch, { foreignKey: "batch_id", as: "batch" });
QualityCheck.belongsTo(ReasonCodeMaster, { foreignKey: "reason_code_id", as: "reasonCode" });
...
MachineLog.belongsTo(MachineMaster, { foreignKey: "machine_id", as: "machine" });
MachineLog.belongsTo(User, { foreignKey: "operator_id", as: "operator" });
MachineLog.belongsTo(ReasonCodeMaster, { foreignKey: "downtime_reason_id", as: "downtimeReason" });
SeparatorOutput.belongsTo(ProductionBatch, { foreignKey: "batch_id", as: "batch" });
ShinerProcess.belongsTo(ProductionBatch, { foreignKey: "batch_id", as: "batch" });
...
ByProductInventory.belongsTo(MaterialMaster, { foreignKey: "material_id", as: "material" });
SalesOrder.belongsTo(Customer, { foreignKey: "customer_id", as: "customer" });
SalesOrder.belongsTo(MaterialMaster, { foreignKey: "material_id", as: "material" });
...
MachineMaintenance.belongsTo(MachineMaster, { foreignKey: "machine_id", as: "machine" });
...
QualityParameterMaster.belongsTo(PlantMaster, { foreignKey: "plant_id", as: "plant" });
...
ByProductInventory.belongsTo(PlantMaster, { foreignKey: "plant_id", as: "plant" });
