...
SeparatorOutput.init(
  {
    ...
    cleaned_qty: { type: DataTypes.DECIMAL(12, 2) },
    impurity_qty: { type: DataTypes.DECIMAL(12, 2) },
    stone_qty: { type: DataTypes.DECIMAL(12, 2) },
    dust_qty: { type: DataTypes.DECIMAL(12, 2) },
